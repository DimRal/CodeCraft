...
Καθώς δεν είναι εφικτό να ανεβάσω το AI Key ώστε να λειτουργήσει το δικό μας AI, παρακαλώ αφαιρέστε τα // απο τις  κατάλληλες γραμμές του κώδικα για να μπορέσει το πρόγραμμα να λειτουργήσει σωστά.
