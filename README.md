...
Καθώς δεν είναι εφικτό να ανεβάσω το AI Key ώστε να λειτουργήσει το δικό μας AI, παρακαλώ προσθέτστε  στις  κατάλληλες γραμμές του κώδικα το δικο σας openAI key API για να μπορέσει το πρόγραμμα να λειτουργήσει σωστά.
...
-Αποθηκεύστε τις αλλαγές και εκτελέστε το πρόγραμμα.
---SOS---
