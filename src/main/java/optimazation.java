...
public class optimazation {
  ...
  public static double[] optimizeMealIngredients(Macros[] meal, Macros totalGoal, double percentageOfGoal) {
    ...
    // Lower bound (i.e. the minimum value) for each macro: Change as needed
    /*double[] lB = new double[] {goal.calories-200, goal.protein-10, goal.carbs-10, goal.fat-10};

    // Upper bound (i.e. the most extreme value) for each macro: Change as needed
    double[] uB = new double[] { goal.calories, goal.protein, goal.carbs, goal.fat };
    // Lower bound (i.e. the minimum value) for each macro: Change as needed/* */
